              ...
              MixinNativeSecretWalletInfo(
                MixinNativeTerraWalletInfo(
                  MixinNativeKavaWalletInfo(
                    MixinNativeArkeoWalletInfo(MixinNativeOsmosisWalletInfo(
                      MixinNativeMayachainWalletInfo(NativeHDWalletBase))
                    )
                  )
                )
              )
            ...
            MixinNativeThorchainWallet(
              MixinNativeSecretWallet(
                MixinNativeTerraWallet(
                  MixinNativeKavaWallet(MixinNativeOsmosisWallet(MixinNativeArkeoWallet(MixinNativeMayachainWallet(NativeHDWalletInfo))))
                )
              )
            )
          )
